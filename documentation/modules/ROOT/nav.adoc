...
** xref:index.adoc#story[{module}.{counter:submodule1} The story behind this solution pattern]
** xref:index#the_solution[{module}.{counter:submodule1} The solution]
...
* https://redhat-solution-patterns.github.io/[Explore other Red Hat Solution Patterns^]