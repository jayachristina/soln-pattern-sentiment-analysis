...
For building the *Sentiment Analysis* and *Reviews Moderation* Intelligent Applications based on AIML, the solution leverages https://www.redhat.com/en/technologies/cloud-computing/openshift/openshift-data-science[Red Hat OpenShift Data Science^] platform. With OpenShift Data Science, the organizations can
